...
Just finished this course and wanted to jot down what it covered.

## What it's about

A hands-on course on building apps with the Claude/Anthropic API — from your first API call all the way to multi-agent systems.
...
Know Python, and be comfortable with JSON.

## Good for

Backend/full-stack devs, data engineers, DevOps folks, and anyone building chatbots or AI features into their apps.
